========================================================================
    WIN32 应用程序：Renju UI 项目概述
========================================================================

应用程序向导已为您创建了此 Renju UI 应用程序。

本文件概要介绍组成 Renju UI 应用程序的每个文件的内容。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 Renju UI.pch 的预编译头 (PCH) 文件和
